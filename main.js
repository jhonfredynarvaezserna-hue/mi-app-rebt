...
// Catálogo técnico profesional (Estrella-Triángulo, Sonoff, Vehículos Eléctricos, Fotovoltaica e ICT-2)
const VIDEOS_TECNICOS_SM = [
    {
        id: "AiT3uWCY6BQ",
        titulo: "⚙️ Arranque Estrella-Triángulo: Potencia y Mando Explicado",
        categoria: "Automatismos"
    },
    {
        id: "1DBXkg5-5sY",
        titulo: "📱 Conexión e Instalación Práctica de Dispositivos Sonoff",
        categoria: "Domótica"
    },
    {
        id: "2Vv-BfVoq4g",
        titulo: "🚗 Instalación y Funcionamiento de Puntos de Recarga para Coches Eléctricos",
        categoria: "Vehículo Eléctrico"
    },
    {
        id: "9bZkp7q19f0",
        titulo: "🌞 Dimensionamiento y Montaje de Instalaciones Solar Fotovoltaica",
        categoria: "Fotovoltaica"
    },
    {
        id: "oxeOtf38jQ4",
        titulo: "📡 Infraestructuras de Telecomunicaciones ICT-2 y Fibra Óptica",
        categoria: "ICT-2"
    }
];
...
function cargarVideoTecnico(index) {
    ...
    if (video) {
        cargarVideo(video.id, video.titulo);
    }
}
